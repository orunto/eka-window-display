              ...
              <form onSubmit={(e) => handleSubmit(e, ["about_us_title", "about_us_content"])} className="space-y-4">
                <div>
                  ...
                  <Input
                    id="about_us_title"
                    name="about_us_title"
                    defaultValue={getSetting("about_us_title")}
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    defaultValue={getSetting("about_us_content")}
                    rows={12}
                    className="bg-eka-emerald-depth/60 border-eka-jade-luxury/30 text-eka-pearl"
                  />
                </div>
              ...
              <form onSubmit={(e) => handleSubmit(e, ["bespoke_title", "bespoke_intro", "bespoke_process", "bespoke_timeline", "bespoke_pricing"])} className="space-y-4">
                <div>
                  ...
                  <Input
                    id="bespoke_title"
                    name="bespoke_title"
                    defaultValue={getSetting("bespoke_title")}
                    className="bg-eka-emerald-depth/60 border-eka-jade-luxury/30 text-eka-pearl"
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    id="bespoke_intro"
                    name="bespoke_intro"
                    defaultValue={getSetting("bespoke_intro")}
                    rows={4}
                    className="bg-eka-emerald-depth/60 border-eka-jade-luxury/30 text-eka-pearl"
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    id="bespoke_process"
                    name="bespoke_process"
                    defaultValue={getSetting("bespoke_process")}
                    rows={16}
                    className="bg-eka-emerald-depth/60 border-eka-jade-luxury/30 text-eka-pearl font-mono text-sm"
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    id="bespoke_timeline"
                    name="bespoke_timeline"
                    defaultValue={getSetting("bespoke_timeline")}
                    rows={3}
                    className="bg-eka-emerald-depth/60 border-eka-jade-luxury/30 text-eka-pearl"
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    id="bespoke_pricing"
                    name="bespoke_pricing"
                    defaultValue={getSetting("bespoke_pricing")}
                    rows={3}
                    className="bg-eka-emerald-depth/60 border-eka-jade-luxury/30 text-eka-pearl"
                  />
                </div>
